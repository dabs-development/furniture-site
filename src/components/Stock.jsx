...
const Stock = ({ openModal}) => {
    ...
    <Flex bg="#f1f3f9" flexDirection="column">
        ...
        <Flex margin='auto' flexDirection={{ xl: 'row', lg: 'column', md: 'column', sm: "column" }} color="#fff">
            <Flex width={400} height={200} position="relative" backgroundImage={fon3} backgroundPosition="center" marginTop={10} marginRight={{ xl: '10', lg: '0', md: '0', sm: '0' }} borderEndRadius={5} boxShadow="0px 0px 15px 4px rgba(0,0,0,0.3);">
            ...
            <Flex width={400} height={200} position="relative" backgroundImage={fon4} backgroundPosition="center" marginTop={10} borderEndRadius={5} boxShadow="0px 0px 15px 4px rgba(0,0,0,0.3);">
                <Flex width='68%' bg="#303d4d" opacity="0.5" borderEndRadius={5}>
                    <br />
                </Flex>
                <Box position="absolute" border="2px solid #ffd700" top={5} left={2.5}>
        ...
        <Flex width={400} height={200} position="relative" backgroundImage={fon5} backgroundPosition="center" margin='auto' marginTop={10} borderEndRadius={5} boxShadow="0px 0px 15px 4px rgba(0,0,0,0.3);">
            <Flex width='68%' bg="#303d4d" opacity="0.5" borderEndRadius={5}>
                <br />
            </Flex>
