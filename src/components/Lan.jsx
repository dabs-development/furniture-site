...
import { Text, Flex, Image, Grid, Button } from "@chakra-ui/react";
...
const Lan = () => {
  ...
  return (
    ...
    >
      ...
      <Flex
        flexDirection="column"
        padding={{ xl: "20px", lg: "20px", md: "20px", sm: "10px" }}
      >
        <Text
          color="#79B52D"
        ...
        <Text marginTop={5}>
          ...
          материалов. Каждая деталь корпусной мебели отражает внимание к дизайну
          и функциональности, обеспечивая комфорт и уют в интерьере. Благодаря
          разнообразию стилей, от классики до современного минимализма,
          корпусная мебель позволяет подобрать оптимальное решение для любого
          помещения. Внимание к деталям, изысканные отделочные материалы и
          продуманные конструкции делают корпусную мебель незаменимым элементом
          интерьера, придающим ему изысканность и функциональность.
        </Text>
        <Button
          width={300}
          colorScheme="teal"
